  ...
  return (
    <View className="flex-1 items-center justify-center bg-white px-4 w-full">
      ...
      <View className="border border-gray-300 rounded-md p-4 w-full ">
        ...
        <TextInput className={`border border-gray-300 rounded-md p-2 mb-4 text-gray-900 ${missingData ? "border-red-500" : ""}`} placeholder="Ingrese su contraseña" value={nombre} onChangeText={setNombre} />
        <Text className="mb-1 font-bold">Nombre de Usuario</Text>
        <TextInput className={`border border-gray-300 rounded-md p-2 mb-4 text-gray-900 ${missingData ? "border-red-500" : ""}`} placeholder="Ingrese su contraseña" value={username} onChangeText={setUsername} />
        <Text className="mb-1 font-bold">Email</Text>
        <TextInput className={`border border-gray-300 rounded-md p-2 mb-4 text-gray-900 ${missingData ? "border-red-500" : ""}`} placeholder="correo@ejemplo.com" value={email} onChangeText={setEmail}/>
        ...
        <TouchableOpacity className={`p-2 w-full flex-row justify-center items-center bg-[#1B5BA5] rounded-md ${loading ? "opacity-70" : ""}`} disabled={loading} onPress={signin}>
      ...
      <Text className="text-gray-500 text-xs text-center mt-4">Al continuar, aceptas nuestros Términos de servicio y Aviso de privacidad</Text>
    </View>
)
}